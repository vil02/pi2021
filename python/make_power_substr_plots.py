...
def prepare_frame_data(in_frame_number, in_power_base, in_output_folder):
    ...
    with open(in_output_folder/tex_file_name, 'w',  encoding='utf-8') as tex_file:
        tex_file.write('\\begin{frame}\n')
        tex_file.write('  \\begin{figure}\n')
        tex_file.write('    \\centering\n')
        tex_file.write(f'    \\includegraphics[width=\\textwidth]{{{pdf_file_name}}}\n')
        tex_file.write(
...
OUTPUT_FOLDER = pathlib.Path(__file__).parents[1]/'tmp_data'/'power_substr_plots'
