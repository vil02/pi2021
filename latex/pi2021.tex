...
\subimport{\tmpdatapath}{\expSubstrPlotsTex}
...
\begin{frame}
  \begin{figure}
    \subimport{\tmpdatapath}{\wheelsRationalTex}
  \end{figure}
  \begin{theorem}
...
\begin{frame}
  \begin{figure}
    \subimport{\tmpdatapath}{\wheelsIrrationalTex}
  \end{figure}
\end{frame}
...
\subimport{\tmpdatapath}{\fracPartsOfRationalMultiplesTex}

\begin{frame}
  \begin{example}
    Rozważmy ciąg ${\paren{\fracpart{n\pi}}}_{n \in \N}$.
    \begin{figure}
      \subimport{\tmpdatapath}{\fracPartsOfIrationalMultiplesTex}
    \end{figure}
  \end{example}
  \begin{theorem}
