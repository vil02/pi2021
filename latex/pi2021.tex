...
\subimport{\tmpdatapath}{power_substr_plots.tex}
...
\begin{frame}
  \begin{figure}
    \subimport{\tmpdatapath}{wheels_rational.tex}
  \end{figure}
  \begin{theorem}
...
\begin{frame}
  \begin{figure}
    \subimport{\tmpdatapath}{wheels_irrational.tex}
  \end{figure}
\end{frame}
...
\subimport{\tmpdatapath}{fracparts_of_rational_multiples.tex}

\begin{frame}
  \begin{example}
    Rozważmy ciąg ${\paren{\fracpart{n\pi}}}_{n \in \N}$.
    \begin{figure}
      \subimport{\tmpdatapath}{fracparts_of_irrational_multiples.tex}
    \end{figure}
  \end{example}
  \begin{theorem}
